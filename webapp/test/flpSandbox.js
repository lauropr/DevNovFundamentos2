		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fundamentos",
									"targetURL": "#demofundamentos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demofundamentos-display": {
								"semanticObject": "demofundamentos",
								"action": "display",
								"description": "Fundamentos de UI5 Freestyle",
								"title": "Fundamentos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.fundamentos",
									"url": sap.ui.require.toUrl("demo/fundamentos")
								}
							}
						}
					}
